...
- `_surface_stderr_warnings()` (`usethis._backend.poetry.call`) — Surface any warning lines from Poetry's stderr output.
...
- `_surface_stderr_warnings()` (`usethis._backend.uv.call`) — Surface any warning lines from uv's stderr output.
