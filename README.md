...
- [`usethis arch`](https://usethis.readthedocs.io/en/stable/cli/reference#usethis-arch) — Add/Configure recommended architecture tools (namely, [Import Linter](https://import-linter.readthedocs.io/en/stable/)).
