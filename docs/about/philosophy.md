...
- CI configuration has important security implications to consider. It's not something that is necessarily sensible to try and automate compared to Python developer tooling and project configuration.
